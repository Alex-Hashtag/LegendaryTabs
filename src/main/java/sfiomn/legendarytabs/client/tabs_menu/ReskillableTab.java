...
public class ReskillableTab extends TabBase {
    private final ResourceLocation TAB_ICON = new ResourceLocation(LegendaryTabs.MOD_ID, "textures/gui/reskillable.png");
    ...
    public boolean isEnabled(Player player) {
        return Config.Baked.reskillableTabEnabled && LegendaryTabs.reskillableLoaded;
    }
    ...
    public boolean isCurrentlyUsed(Screen currentScreen) {
        return LegendaryTabs.reskillableLoaded && currentScreen instanceof SkillScreen;
    }

    @Override
    public Component getTooltip() {
        return Component.translatable("tooltip." + LegendaryTabs.MOD_ID + ".tab.reskillable.description");
    }
