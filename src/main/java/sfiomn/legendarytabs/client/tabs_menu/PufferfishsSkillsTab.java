...
public class PufferfishsSkillsTab extends TabBase {
    private final ResourceLocation TAB_ICON = new ResourceLocation(LegendaryTabs.MOD_ID, "textures/gui/idk2.png");
    ...
    public Component getTooltip() {
        return Component.translatable("tooltip." + LegendaryTabs.MOD_ID + ".tab.pufferfish_skills.description");
    }
    ...
    public void initTabOnScreens() {
        ...
        if (LegendaryTabs.curiosLoaded)
            TabsMenu.addTabToScreen(this, CuriosScreenV2.class, (player) -> 176, (player) -> 166, 40);
