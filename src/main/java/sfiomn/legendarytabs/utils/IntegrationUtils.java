...
public class IntegrationUtils {
    ...
    public static int getTravelersBackpackWidth(Player player) {
        ...
        if (wrapper != null) {
            ...
            LegendaryTabs.LOGGER.debug("travelers width : " + (wider ? (tanksVisible ? 256 : 212) : (tanksVisible ? 220 : 176)));
            return wider ? (tanksVisible ? 256 : 212) : (tanksVisible ? 220 : 176);
        }
        LegendaryTabs.LOGGER.debug("wrapper is null");
        return 176;
    }
    ...
    public static int getTravelersBackpackHeight(Player player) {
        ...
        if (wrapper != null) {
            ...
            LegendaryTabs.LOGGER.debug("travelers height : " + (17 + slotsHeight + playerInventoryHeight));
